...
public class InteractiveWorkloadPerformanceTest {
                ...
                for (File streamDir : streamsDirs) {
                        ...
                        for (int threadCount : threadCounts) {
                                doIgnoreTimesPerformanceTest(
                                                ...
                                                new File(streamDir, "snb/interactive/updateStream.properties")
                                                                .getAbsolutePath());
                        }
                }
        }
        ...
        private void doIgnoreTimesPerformanceTest(int threadCount,
                ...
                try {
                        ...
                        paramsMap.put(DummyLdbcSnbInteractiveDb.SLEEP_TYPE_ARG,
                                        DummyLdbcSnbInteractiveDb.SleepType.SPIN.name());
                        ...
                        double microSecondPerOperation = (double) TimeUnit.NANOSECONDS
                                        .toMicros(resultsSnapshot.totalRunDurationAsNano()) / operationCount;
        ...
        public void doWithTimesPerformanceTest(int threadCount,
                ...
                try {
                        ...
                        double operationsPerSecond = Math.round(
                                        (actualOperationCount / resultsSnapshot.totalRunDurationAsNano())
                                                        * TimeUnit.SECONDS.toNanos(1));
                        double microSecondPerOperation = (double) TimeUnit.NANOSECONDS
                                        .toMicros(resultsSnapshot.totalRunDurationAsNano()) /
