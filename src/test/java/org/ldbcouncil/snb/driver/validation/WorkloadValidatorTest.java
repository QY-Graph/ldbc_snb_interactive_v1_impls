...
import org.ldbcouncil.snb.driver.workloads.dummy.DummyWorkloadFactory;
...
public class WorkloadValidatorTest {
        ...
        private WorkloadStreams valid1(Set<Class<? extends Operation>> dependentOperationTypes) {
                ...
                workloadStreams.addAsynchronousStream(
                                ...
                                Lists.<Operation>newArrayList(
                                                ...
                                                new TimedNamedOperation1(12, 12, 2, "name1")).iterator(),
                                null);
        ...
        private WorkloadStreams invalid1(Set<Class<? extends Operation>> dependentOperationTypes) {
                ...
                workloadStreams.addAsynchronousStream(
                                ...
                                Lists.<Operation>newArrayList(
                                                new TimedNamedOperation2(10, 10, 0, "name2"),
                                                new TimedNamedOperation2(11, 11, 1, "name2"),
                                                new TimedNamedOperation1(12, 12, -1, "name1")).iterator(),
                                null);
                return workloadStreams;
        }
        ...
        public void shouldTestThatAllOperationsHaveDependencyTimeSet()
                ...
                DriverConfiguration configuration = ConsoleAndFileDriverConfiguration.fromDefaults(null, null,
                                operationCount);

                WorkloadFactory validWorkloadFactory = new DummyWorkloadFactory(validStreams.iterator(),
                                maxExpectedInterleaveAsMilli);
                WorkloadFactory invalidWorkloadFactory = new DummyWorkloadFactory(invalidStreams.iterator(),
                                maxExpectedInterleaveAsMilli);
        ...
        private WorkloadStreams valid2(Set<Class<? extends Operation>> dependentOperationTypes) {
                ...
                workloadStreams.addAsynchronousStream(
                                ...
                                Lists.<Operation>newArrayList(
                                                new TimedNamedOperation2(10, 10, 0, "name2"),
                                                new TimedNamedOperation2(11, 11, 1, "name2"),
                                                new TimedNamedOperation1(12, 12, 11, "name1")).iterator(),
                                null);
                return workloadStreams;
        }
        ...
        private WorkloadStreams invalid2(Set<Class<? extends Operation>> dependentOperationTypes) {
                ...
                workloadStreams.addAsynchronousStream(
                                ...
                                Lists.<Operation>newArrayList(
                                                new TimedNamedOperation2(10, 10, 0, "name2"),
                                                new TimedNamedOperation2(11, 11, 1, "name2"),
                                                new TimedNamedOperation1(12, 12, 13, "name1")).iterator(),
                                null);
                return workloadStreams;
        }
        ...
        private WorkloadStreams invalid3(Set<Class<? extends Operation>> dependentOperationTypes) {
                ...
                workloadStreams.addAsynchronousStream(
                                ...
                                Lists.<Operation>newArrayList(
                                                new TimedNamedOperation2(10, 10, 0, "name2"),
                                                new TimedNamedOperation2(11, 11, 1, "name2"),
                                                new TimedNamedOperation2(12, 12, 2, "name2")).iterator(),
                                null);
                return workloadStreams;
        }
        ...
        public void shouldTestForDeterminism()
                ...
                WorkloadFactory validWorkloadFactory = new DummyWorkloadFactory(streams1a.iterator(),
                                validAlternativeOperations.iterator(),
                                maxExpectedInterleaveAsMilli);
                WorkloadFactory invalidWorkloadFactory = new DummyWorkloadFactory(streams1b.iterator(),
                                invalidAlternativeOperations.iterator(),
                                maxExpectedInterleaveAsMilli);
        ...
        public void shouldPassWhenAllOperationsHaveStartTimesAndMaxInterleaveIsNotExceeded()
                ...
                DriverConfiguration configuration = ConsoleAndFileDriverConfiguration.fromDefaults(null, null,
                                operationCount);
                WorkloadFactory workloadFactory = new DummyWorkloadFactory(streams.iterator(),
                                maxExpectedInterleaveAsMilli);
                ...
                stream1.addAsynchronousStream(
                                ...
                                Iterators.concat(
                                                gf.limit(
                                                                new TimedNamedOperation1Factory(
                                                                                gf.incrementing(startTimeAsMilli, 10l),
                                                                                gf.incrementing(startTimeAsMilli - 1,
                                                                                                0l),
                                                                                gf.constant("name")),
                                                                operationCount - 1),
                                                gf.<Operation>identity(
                                                                new TimedNamedOperation1(
                                                                                lastStartTimeAsMilli
                                                                                                + excessiveInterleaveAsMilli,
                                                                                lastStartTimeAsMilli
                                                                                                + excessiveInterleaveAsMilli,
                                                                                0,
                                                                                "name"))),
                ...
                stream2.addAsynchronousStream(
                                ...
                                Iterators.concat(
                                                gf.limit(
                                                                new TimedNamedOperation1Factory(
                                                                                gf.incrementing(startTimeAsMilli, 10l),
                                                                                gf.incrementing(startTimeAsMilli - 1l,
                                                                                                0l),
                                                                                gf.constant("name")),
                                                                operationCount - 1),
                                                gf.<Operation>identity(
        ...
        public void shouldFailWhenOperationStartTimesAreNotMonotonicallyIncreasing()
                ...
                DriverConfiguration configuration = ConsoleAndFileDriverConfiguration.fromDefaults(null, null,
                                operationCount);
                WorkloadFactory workloadFactory = new DummyWorkloadFactory(streams.iterator(),
                                Workload.DEFAULT_MAXIMUM_EXPECTED_INTERLEAVE_AS_MILLI);
                WorkloadValidator workloadValidator = new WorkloadValidator();
                WorkloadValidationResult result = workloadValidator.validate(
                                workloadFactory,
                                configuration,
