...
import org.ldbcouncil.snb.driver.runtime.metrics.ContinuousMetricSnapshot;
...
public class WorkloadStatisticsCalculatorTest {
        ...
        public void shouldReturnCorrectWorkloadStatisticsForWorkloadsWithSingleOperationType()
                ...
                ContinuousMetricSnapshot operation1Interleaves = stats.operationInterleavesByOperationType()
                                .get(TimedNamedOperation1.class).snapshot();
                ...
                assertThat(stats.operationInterleavesByOperationType().get(TimedNamedOperation2.class),
                                is(nullValue()));

                assertThat(stats.operationInterleavesByOperationType().get(TimedNamedOperation3.class),
                                is(nullValue()));
        ...
        public void shouldReturnCorrectWorkloadStatisticsForWorkloadsWithMultipleOperationTypes()
                ...
                long expectedWorkloadDurationAsMilli = Math.max(Math.max(expectedWorkloadOperation1DurationAsMilli,
                ...
                assertThat(stats.lastStartTimeAsMilli(),
                                equalTo(operation1StartTime + expectedWorkloadDurationAsMilli));
                assertThat(stats.firstStartTimesAsMilliByOperationType().get(TimedNamedOperation1.class),
                ...
                assertThat(dependentOperationTypes,
                                equalTo((Set) Sets.<Class>newHashSet(TimedNamedOperation2.class,
                                                TimedNamedOperation3.class)));
                ...
                ContinuousMetricSnapshot operation2Interleaves = stats.operationInterleavesByOperationType()
                                .get(TimedNamedOperation2.class).snapshot();
                ...
                ContinuousMetricSnapshot operation3Interleaves = stats.operationInterleavesByOperationType()
                                .get(TimedNamedOperation3.class).snapshot();
