...
public class SimpleWorkload extends Workload {
        // NOTE, in a real Workload these would ideally come from configuration and get
        // set in onInit()
        ...
        public WorkloadStreams getStreams(GeneratorFactory gf, boolean hasDbConnected) throws WorkloadException {
                ...
                Iterator<Iterator<Byte>> randomFieldValueGenerator = gf
                                .sizedUniformBytesGenerator(fieldValueLengthGenerator);
                ...
                Iterator<Map<String, Iterator<Byte>>> insertValuedFieldGenerator = gf.weightedDiscreteMap(valuedFields,
                 ...
                 */
                // Read/Update Keys
                Iterator<String> requestKeyGenerator = gf.prefix(gf.dynamicRangeUniform(insertKeyGenerator),
                                KEY_NAME_PREFIX);
                ...
                operations.add(Tuple
                                .tuple2(READ_MODIFY_WRITE_RATIO,
                ...
                Iterator<Operation> workloadOperations = Iterators.concat(initialInsertOperationGenerator,
                                transactionalOperationGenerator);
        ...
        // @Override
        // public String serializeOperation( Operation operation ) throws
        ...
        // {
        // ReadModifyWriteOperation simpleOperation = (ReadModifyWriteOperation)
        // operation;
        // List<Object> operationAsList = new ArrayList<>();
        // operationAsList.add( simpleOperation.getClass().getName() );
        // operationAsList.add( simpleOperation.table() );
        ...
        // catch ( IOException e )
        // {
        // throw new SerializingMarshallingException( format( "Error serializing
        // operation\n%s", operation ), e );
        // }
        // }

        // @Override
        // public Operation marshalOperation( String serializedOperation ) throws
        // SerializingMarshallingException
        // {
        // List<Object> operationAsList;
        // try
        // {
        // operationAsList = Arrays.asList(OBJECT_MAPPER.readValue(serializedOperation,
        // Operation[].class));
        // // operationAsList = OBJECT_MAPPER.readValue( serializedOperation,
        // TYPE_REFERENCE );
        // }
        // catch ( IOException e )
        // {
        ...
        // @Override
        // public boolean resultsEqual( Operation operation, Object result1, Object
        // result2 ) throws WorkloadException
        // {
